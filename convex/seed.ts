...
export const seedDemoData = internalMutation({
  ...
  handler: async (ctx) => {
    ...
    await ctx.db.insert("vendorQuotations", {
      ...
      productDescription: "Bulk discount available for orders over 50 units.",
      active: true,
      createdAt: Date.now(),
      updatedAt: Date.now(),
    });
    ...
    await ctx.db.insert("vendorQuotations", {
      ...
      productDescription: "Factory direct pricing. Color calibrated.",
      active: true,
      createdAt: Date.now(),
      updatedAt: Date.now(),
    });
    ...
    await ctx.db.insert("vendorQuotations", {
      ...
      productDescription: "Premium motorized version. Includes cable management.",
      active: true,
      createdAt: Date.now(),
      updatedAt: Date.now(),
    });

    // Create Vendor Quotations - Vendor 3 (Global Office Supply)
    await ctx.db.insert("vendorQuotations", {
      vendorId: vendor3Id,
      productId: laptop1Id,
      quotationType: "pre-filled",
      ...
      warrantyPeriod: "1 year",
      productDescription: "Fast shipping. Pre-configured available.",
      active: true,
      createdAt: Date.now(),
      updatedAt: Date.now(),
    });
    ...
    await ctx.db.insert("vendorQuotations", {
      ...
      deliveryTime: "3-5 business days",
      warrantyPeriod: "3 years",
      productDescription: "Standard warranty. Bulk pricing available.",
      active: true,
      createdAt: Date.now(),
      updatedAt: Date.now(),
    });
    ...
    await ctx.db.insert("vendorQuotations", {
      ...
      deliveryTime: "5-7 business days",
      warrantyPeriod: "2 years",
      productDescription: "Contractor grade with carrying case.",
      active: true,
      createdAt: Date.now(),
      updatedAt: Date.now(),
    });
    ...
    await ctx.db.insert("vendorQuotations", {
      ...
      deliveryTime: "1-2 business days",
      warrantyPeriod: "N/A",
      productDescription: "Eco-friendly paper. Free delivery for bulk orders.",
      active: true,
      createdAt: Date.now(),
      updatedAt: Date.now(),
    });
    ...
    await ctx.db.insert("vendorQuotations", {
      ...
      deliveryTime: "2-3 business days",
      warrantyPeriod: "N/A",
      productDescription: "Multi-pack discount. Smooth writing guaranteed.",
      active: true,
      createdAt: Date.now(),
      updatedAt: Date.now(),
    });

    // Create Vendor Quotations - Vendor 4 (Industrial Direct)
    await ctx.db.insert("vendorQuotations", {
      vendorId: vendor4Id,
      productId: drill1Id,
      quotationType: "pre-filled",
      ...
      deliveryTime: "7-10 business days",
      warrantyPeriod: "5 years",
      productDescription: "Extended warranty. Technical support included.",
      active: true,
      createdAt: Date.now(),
      updatedAt: Date.now(),
    });
    ...
    await ctx.db.insert("vendorQuotations", {
      ...
      warrantyPeriod: "3 years",
      productDescription: "Industrial grade. Installation service available.",
      active: true,
      createdAt: Date.now(),
      updatedAt: Date.now(),
    });
