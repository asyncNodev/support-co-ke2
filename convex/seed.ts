  ...
  handler: async (ctx) => {
    ...
    const products = [
      // Diagnostic Equipment
      {
        ...
        categoryId: diagnosticEquipment,
      ...
      },
      {
        ...
        categoryId: diagnosticEquipment,
        description: "Fast reading infrared thermometer",
        sku: "TH-300",
      },
      {
      ...
      },
      {
        ...
        categoryId: diagnosticEquipment,
        description: "Portable electrocardiograph machine",
        sku: "ECG-600",
      },
      {
        name: "Nebulizer Compressor",
        categoryId: diagnosticEquipment,
        description: "Medical nebulizer for respiratory treatment",
        sku: "NB-700",
      },
      ...
      // Patient Care Equipment
      {
        ...
        categoryId: patientCare,
        description: "3-function electric hospital bed with mattress",
        sku: "HB-800",
      },
      {
        name: "Wheelchair Standard",
        categoryId: patientCare,
        description: "Manual folding wheelchair with footrest",
        sku: "WC-900",
      },
      {
        name: "Walking Frame",
        categoryId: patientCare,
        description: "Adjustable aluminum walking aid",
        sku: "WF-1000",
      },
      {
      ...
      },
      {
        ...
        categoryId: patientCare,
        description: "Medical grade oxygen concentrator",
        sku: "OC-1200",
      },
      {
        name: "Suction Machine Portable",
        categoryId: patientCare,
        description: "Electric suction apparatus",
        sku: "SM-1300",
      },
      {
        name: "IV Stand Stainless Steel",
        categoryId: patientCare,
        description: "Height adjustable IV pole with wheels",
        sku: "IV-1400",
      },
      ...
      // Laboratory Equipment
      {
        ...
        categoryId: laboratoryEquipment,
        description: "LED illuminated laboratory microscope",
        sku: "MC-1500",
      },
      {
        name: "Centrifuge Laboratory",
        categoryId: laboratoryEquipment,
        description: "Benchtop centrifuge 4000 RPM",
        sku: "CF-1600",
      },
      {
        name: "Autoclave Sterilizer",
        categoryId: laboratoryEquipment,
        description: "Steam sterilizer 18L capacity",
        sku: "AC-1700",
      },
      {
        name: "Lab Incubator",
        categoryId: laboratoryEquipment,
        description: "Digital temperature controlled incubator",
        sku: "IN-1800",
      },
      {
      ...
      },
      {
        name: "Pipette Set",
        categoryId: laboratoryEquipment,
        description: "Variable volume micropipettes 3-piece set",
        sku: "PP-2000",
      },
      ...
      // Surgical Instruments
      {
        ...
        categoryId: surgicalInstruments,
        description: "Stainless steel surgical scissors 5-piece",
        sku: "SS-2100",
      },
      {
        name: "Forceps Set",
        categoryId: surgicalInstruments,
        description: "Surgical forceps assorted 10-piece",
        sku: "FC-2200",
      },
      {
        name: "Scalpel Handle Set",
        categoryId: surgicalInstruments,
        description: "Scalpel handles with disposable blades",
        sku: "SH-2300",
      },
      {
        name: "Surgical Blade Box",
        categoryId: surgicalInstruments,
        description: "Sterile surgical blades 100-pack",
        sku: "SB-2400",
      },
      {
        name: "Needle Holder",
        categoryId: surgicalInstruments,
        description: "Surgical needle holder 15cm",
        sku: "NH-2500",
      },
      ...
      // Medical Disposables
      {
        ...
        categoryId: medicalDisposables,
        description: "Nitrile examination gloves 100-pack",
        sku: "GL-2600",
      },
      {
        name: "Surgical Face Masks Box",
        categoryId: medicalDisposables,
        description: "3-ply surgical masks 50-pack",
        sku: "FM-2700",
      },
      {
        name: "Syringes 10ml Pack",
        categoryId: medicalDisposables,
        description: "Disposable syringes with needles 100-pack",
        sku: "SY-2800",
      },
      {
        name: "Gauze Bandage Roll",
        categoryId: medicalDisposables,
        description: "Sterile gauze bandage 10cm x 4m",
        sku: "GB-2900",
      },
      {
        name: "Cotton Wool Roll",
        categoryId: medicalDisposables,
        description: "Absorbent cotton wool 500g",
        sku: "CW-3000",
      },
      {
        name: "Alcohol Swabs Box",
        categoryId: medicalDisposables,
        description: "Sterile alcohol prep pads 200-pack",
        sku: "AS-3100",
      },
      {
        name: "Urine Collection Bags",
        categoryId: medicalDisposables,
        description: "Sterile urine bags 2000ml 20-pack",
        sku: "UB-3200",
      },
      {
        name: "IV Cannula Set",
        categoryId: medicalDisposables,
        description: "IV catheter assorted sizes 50-pack",
        sku: "IC-3300",
      },
      ...
      // Hospital Furniture
      {
        ...
        categoryId: hospitalFurniture,
        description: "Adjustable examination couch with paper roll",
        sku: "ET-3400",
      },
      {
        name: "Bedside Cabinet",
        categoryId: hospitalFurniture,
        description: "Hospital bedside locker with drawer",
        sku: "BC-3500",
      },
      {
        name: "Medicine Trolley",
        categoryId: hospitalFurniture,
        description: "Stainless steel medicine cart 3-tier",
        sku: "MT-3600",
      },
      {
        name: "Overbed Table",
        categoryId: hospitalFurniture,
        description: "Height adjustable overbed table with wheels",
        sku: "OT-3700",
      },
      {
        name: "Instrument Trolley",
        categoryId: hospitalFurniture,
        description: "Stainless steel instrument trolley 2-tier",
        sku: "IT-3800",
      },
    ];

    // STEP 3.1: BASE PRICES FOR PRODUCTS
    const basePrices = [
      4500,
      3200,
      1500,
    ...
    const productIds = [];
    // If you have a basePrices array, use it:
    for (let i = 0; i < products.length; i++) {
      const product = products[i];
      const price = basePrices?.[i] ?? 0; // Use basePrices if available, else 0
    ...
    const vendor1 = await ctx.db.insert("users", {
      ...
      passwordHash: "", // No login for demo vendors
    ...
    for (let i = 0; i < productIds.length; i++) {
      ...
      for (let j = 0; j < numQuotations; j++) {
        ...
        await ctx.db.insert("vendorQuotations", {
          ...
          countryOfOrigin: ["Kenya", "China", "Germany", "USA", "India"][
            Math.floor(Math.random() * 5)
          ],
          productSpecifications:
            "Medical grade, CE/ISO certified, meets international standards",
          active: true,
          createdAt: Date.now(),
          updatedAt: Date.now(),
        });
    ...
    const scrapingSources = [
      {
        name: "AlphaMed Kenya",
        url: "https://alphamed.co.ke/",
        country: "Kenya",
      },
      {
        name: "Mediplug Equipment",
        url: "https://mediplugequipment.co.ke/",
        country: "Kenya",
      },
      {
        name: "Enza Supplies",
        url: "https://enzasupplies.co.ke/",
        country: "Kenya",
      },
      {
        name: "Apical Medical",
        url: "https://www.apicalmed.com/",
        country: "Kenya",
      },
      {
        name: "Medipal Medical Supplies",
        url: "https://medipalmedicalsupplies.co.ke/",
        country: "Kenya",
      },
      {
        name: "Medical Equipment Supplies Kenya",
        url: "https://www.medicalequipmentsupplieskenya.com/",
        country: "Kenya",
      },
      {
        name: "Crown Healthcare Kenya",
        url: "https://www.crownkenya.com/",
        country: "Kenya",
      },
    ];
    ...
    return {
      success: true,
      message:
        "Medical supplies data seeded successfully! All old data removed.",
      stats: {
        categories: 6,
